...
A web-based Meshtastic mesh radio client for messaging, image transfer, and node management. The key purpose of this was to investigate a way to compress images in 1/2/4 bit with an efficient encoding and compression model to transmit small images over the Meshtastic Network.
